...
## Correção v2.3.2
- Corrigido erro de build no Render em `app/pdv/page.tsx` relacionado a `Set<string>` e target do TypeScript.
- Mantidas as correções da v2.3.1 para NPM oficial, Node 20.x e PDV/relatórios.
